...
class ACIndex:
	...
	def run(self):
		start = timeit.default_timer(); count = 0;
		...
		print 'Counts:\tTitles: ' + str(len(self.titles)) + '\tSubjects: ' + str(len(self.subjects)) + '\tAuthors: ' + str(len(self.authors))
